/**
 * NumberInputRow Component
 * This component renders a row with a label and an input field.
 * @param {Object} props - The props object for the NumberInputRow component.
 ...
 * @returns {JSX.Element} 
 */
export const NumberInputRow = ({ formLabel, idName, min, max, defaultValue }) => {
  return (
    <div className="row mb-3">
      <label htmlFor={idName} className="col-md-4 col-form-label">{formLabel}</label>
